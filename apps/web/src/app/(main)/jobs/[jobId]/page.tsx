            ...
            <div className="max-w-4xl mx-auto px-4 space-y-6">
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="text-sm text-gray-600 space-y-1">
                        <div>Job ID: <code className="bg-gray-100 px-2 py-1 rounded">{job.jobId}</code></div>
                        <div>Project ID: <code className="bg-gray-100 px-2 py-1 rounded">{job.projectId}</code></div>
                        <div>类型: {job.type}</div>
                    </div>
                </div>
